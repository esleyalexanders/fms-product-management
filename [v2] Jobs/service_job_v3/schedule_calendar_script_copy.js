...
function seedData() {
    if (!localStorage.getItem('fms_copy_learning_services')) {
        const services = [
            {
                id: 'ls_001',
                name: 'Algebra Basics',
        ...
        localStorage.setItem('fms_copy_learning_services', JSON.stringify(services));
    }

    if (!localStorage.getItem('fms_copy_sessions')) {
        ...
        localStorage.setItem('fms_copy_sessions', JSON.stringify(sessions));
    }
}
...
function loadEvents() {
    ...
    // Load sessions
    try {
        const sessions = JSON.parse(localStorage.getItem('fms_copy_sessions') || '[]');
...
function deleteEvent(eventId, eventType) {
    ...
    try {
        ...
        localStorage.setItem('fms_copy_sessions', JSON.stringify(filtered));

// Manage Team Create Page Script
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (validateForm()) {
            ...
            formData.append('sendInvite', document.getElementById('sendInvite').checked);
            ...
            // Persist scheduling to localStorage for demo purposes
            try { localStorage.setItem('demo_last_staff', JSON.stringify(Object.fromEntries(formData))); } catch(e){}
    ...
    // Before submit, collect availability ranges into scheduling (replace previous single range model)
    const originalSubmit = form.querySelector('[type="submit"]');
    // Note: submission already handled; we just ensure scheduling building handles new UI (handled above in collect code)
});